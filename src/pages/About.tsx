          ...
          <div className="pl-8 md:pl-12 xl:pl-16">
            ...
            <div className="max-w-2xl space-y-5 text-[15px] leading-[26px] text-text md:space-y-6 md:text-base md:leading-[30px] xl:text-lg xl:leading-9">
              <p>
                ...
                Πανεπιστημίου Θεσσαλονίκης. Η θεραπευτική της προσέγγιση είναι η
                Γνωσιακή Συμπεριφορική Θεραπεία.
              </p>

              <p>
                Στις προπτυχιακές της σπουδές ασχολήθηκε με την Οργανωσιακή και
                Εργασιακή Ψυχολογία, τόσο μέσω της πτυχιακής της εργασίας όσο
                και της πρακτικής της άσκησης. Το ενδιαφέρον της επικεντρώθηκε
                σε ζητήματα εργασιακής ευημερίας και στη σύνδεση του εργασιακού
                περιβάλλοντος με την ψυχική ευεξία και τη συνολική
        ...
        <div className="mx-auto max-w-5xl pl-8 md:pl-12 xl:pl-16">
          <div className="max-w-4xl space-y-5 text-[15px] leading-[26px] text-text md:space-y-6 md:text-base md:leading-[30px] xl:text-lg xl:leading-9">
            <p>
              ...
              και στο εξωτερικό. Έχει εργαστεί σε διαφορετικά πλαίσια με παιδιά,
              ενήλικες, ηλικιωμένους και άτομα με αναπηρία.
            </p>
            ...
            <p>
              ...
              συναισθηματικών και συμπεριφορικών δυσκολιών, καθώς και ζητημάτων
            ...
            <p>
              ...
              γραφείο στο κέντρο της Καβάλας, παρέχοντας υπηρεσίες ψυχοθεραπείας
              τόσο διά ζώσης όσο και διαδικτυακά.
            </p>
          </div>
