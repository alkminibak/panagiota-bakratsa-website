        ...
        <div className="mx-auto max-w-5xl pl-8 md:pl-12 xl:pl-0">
          <div className="max-w-4xl space-y-5 text-[15px] leading-[26px] text-text md:space-y-6 md:text-base md:leading-[30px] xl:text-lg xl:leading-9">
            <p>
              ...
              αποδειχθεί σε ένα ευρύ φάσμα ψυχολογικών δυσκολιών, όπως το άγχος,
              οι δυσκολίες που σχετίζονται με τη διάθεση, τα διατροφικά
              προβλήματα και το πένθος.
            </p>

            <p>
              Βασίζεται στην αντίληψη ότι ο τρόπος με τον οποίο ένα άτομο
              αντιλαμβάνεται και ερμηνεύει όσα συμβαίνουν στη ζωή του επηρεάζει
              τα συναισθήματα και τη συμπεριφορά του. Μέσα από αυτή τη σύνδεση,
              συγκεκριμένοι τρόποι σκέψης και συμπεριφοράς μπορεί να συμβάλλουν
              στη δημιουργία ή στη διατήρηση των ψυχολογικών δυσκολιών που
              αντιμετωπίζει.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl pl-8 md:pl-12 xl:pl-0">
          <div className="max-w-4xl text-[15px] leading-[26px] text-text md:text-base md:leading-[30px] xl:text-lg xl:leading-9">
            <p>
              ...
              αξιοποιούνται διαφορετικές θεραπευτικές τεχνικές και παρεμβάσεις,
              προσαρμοσμένες στις ανάγκες του κάθε ατόμου. Απώτερος στόχος είναι
              το ίδιο το άτομο να γίνει σταδιακά «θεραπευτής του εαυτού του» ,
              αξιοποιώντας τις δεξιότητες που αποκτά κατά τη διάρκεια της
              θεραπείας, ώστε να μπορεί να διαχειρίζεται με μεγαλύτερη αυτονομία
