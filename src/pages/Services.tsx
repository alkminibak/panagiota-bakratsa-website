      ...
      <Container>
        ...
        <div className="px-8 md:px-12 xl:pl-16 xl:pr-0">
          ...
          <div className="relative hidden max-w-5xl gap-8 lg:grid lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
            ...
            <h1 className="mb-10 text-4xl font-medium text-brand">Υπηρεσίες</h1>
          </div>
        </div>
            ...
            >
              ...
              <div className="order-2 space-y-5 text-[15px] leading-[26px] text-text md:space-y-6 md:text-base md:leading-[30px] lg:order-1 xl:text-lg xl:leading-9">
                <p>
                  ...
                  οποία το άτομο διαμορφώνει σταδιακά την ταυτότητά του, αναζητά
                  μεγαλύτερη αυτονομία και καλείται να ανταποκριθεί σε νέες
                  απαιτήσεις στις σχέσεις, την οικογένεια και το σχολικό
                  περιβάλλον.
                </p>
            ...
            >
              ...
              <div className="space-y-5 text-[15px] leading-[26px] text-text md:space-y-6 md:text-base md:leading-[30px] xl:text-lg xl:leading-9">
                <p>
                  ...
                  του παιδιού τους, να αναπτύξουν νέες επικοινωνιακές δεξιότητες
                  και να ενισχύσουν τη σύνδεση μαζί του.
                </p>

                <p>
                  Η συμβουλευτική μπορεί επίσης να προσφέρει υποστήριξη σε
                  περιόδους αλλαγών και μεταβάσεων στη ζωή της οικογένειας, όπως
                  ένα διαζύγιο, η αλλαγή σχολικού περιβάλλοντος, η είσοδος στην
                  εφηβεία ή η προσθήκη ενός νέου μέλους στην οικογένεια. Στόχος
                  είναι η οικογένεια να μπορεί να προσαρμόζεται στις αλλαγές,
                  διατηρώντας ένα αίσθημα ασφάλειας και σταθερότητας για το
